...
export default defineConfig({
  ...
  // @tatious/ui is a linked workspace package with its own development
  // node_modules. Without dedupe, production builds can bundle that package's
  // React alongside this app's React, causing an invalid-hook-call blank page.
  resolve: {
