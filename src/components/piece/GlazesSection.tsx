  ...
  const renderForm = () => (
    <div className="space-y-3">
      ...
      <Textarea
        ...
        placeholder="Notes — application details, ideas… (optional)"
        aria-label="Glaze plan notes"
        rows={2}
        inputSize="sm"
      />
              ...
              <li key={i} className="py-2.5">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {g.notes && (
                      <p className="mt-1 text-xs leading-relaxed text-clay-500 dark:text-clay-400 whitespace-pre-wrap break-words">
                        {g.notes}
                      </p>
                    )}
                  </div>
