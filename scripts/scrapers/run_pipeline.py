...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='GlazeLibrary Scraper Pipeline',
...
Examples:
  ...
  python run_pipeline.py --validate    # Only run validation
    ...
    print("\n" + "=" * 70)
    print("GlazeLibrary Scraper Pipeline")
    ...
    if success:
        ...
        print("\nOutput files:")
        print("  - public/data/glazes.json")
        print("  - public/data/combinations.json")
        print("  - public/images/glazes/")
        print("  - public/images/combinations/")
    else:
