...
from config import AMACO_GLAZE_IMAGES_DIR, SCRAPERS_DIR

def download_missing_images(series_filter=None):
    # Load AMACO glazes
    with open(SCRAPERS_DIR / 'amaco-glaze-fetcher/results/glazes.json') as f:
        data = json.load(f)

    output_dir = AMACO_GLAZE_IMAGES_DIR
