...
# Input data
GLAZES_JSON = PROJECT_ROOT / "public" / "data" / "glazes.json"
COMBINATIONS_JSON = PROJECT_ROOT / "public" / "data" / "combinations.json"

# Image directories
AMACO_COMBO_IMAGES = PROJECT_ROOT / "public" / "images" / "combinations" / "amaco"
MAYCO_COMBO_IMAGES = PROJECT_ROOT / "public" / "images" / "combinations" / "mayco"
GLAZE_IMAGES = PROJECT_ROOT / "public" / "images" / "glazes"
