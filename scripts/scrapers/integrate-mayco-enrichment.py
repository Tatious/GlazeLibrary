...
ENRICHED_FILE = SCRAPERS_DIR / "ai-enrichment/results/enriched-mayco-images.json"
GLAZES_FILE = SCRAPERS_DIR.parent.parent / "public/data/glazes.json"
OUTPUT_FILE = GLAZES_FILE
