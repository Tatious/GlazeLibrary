...
def main():
    ...
    # Update AMACO glazes
    amaco_file = SCRAPERS_DIR / 'amaco-glaze-fetcher/results/glazes.json'
    amaco_image_dir = AMACO_GLAZE_IMAGES_DIR
    if os.path.exists(amaco_file):
        update_glaze_file(amaco_file, 'AMACO', amaco_image_dir)
    
    # Update Mayco glazes
    mayco_file = SCRAPERS_DIR / 'mayco-glaze-fetcher/results/mayco-glazes.json'
    mayco_image_dir = MAYCO_GLAZE_IMAGES_DIR
